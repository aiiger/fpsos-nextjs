      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            <p style={{ marginBottom: 'var(--spacing-3)' }}>
              <strong>Products & Services:</strong> All products and services displayed on the Site are subject to availability. We reserve the right to discontinue or modify any product/service at our discretion. Prices and payments: By default, all payments for services provided will be confirmed via the information provided via our secure booking system. We reserve the right to change pricing or cancel, or refuse any order at our discretion.
            </p>
